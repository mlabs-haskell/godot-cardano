...
godot-cardano is developed and maintained by [MLabs](https://www.mlabs.city/).
...
**Daniel Farrelly** (@danielfarrelly)
- **Role**: Developer
- **Email**: <daniel@mlabs.city>
...
- **Ad-hoc**: #godot-wallet channel at MLabs' Slack
