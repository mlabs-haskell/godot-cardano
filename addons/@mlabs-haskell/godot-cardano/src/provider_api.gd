...
## Signal emitted by [method _get_utxos_by_out_ref].
...
## [b]WARNING: Virtual function.[/b][br]
##
## Get the [Utxo]s located at [param _address].
...
## [b]WARNING: Virtual function.[/b][br]
##
## Get a list of [Utxo]s containing the specified [param _asset].
...
## [b]WARNING: Virtual function.[/b][br]
##
## Obtain the unique [Utxo] specified by the provided [param _tx_hash] and
## [param _output_index].
...
## [b]WARNING: Virtual function.[/b][br]
##
## Get the datum associated to the given [param _datum_hash].
...
## [b]WARNING: Virtual function.[/b][br]
##
## Get the status of a submitted transaction, identified by its [param _tx_hash].
