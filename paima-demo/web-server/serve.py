...
# Taken from manual: https://docs.godotengine.org/en/stable/tutorials/export/exporting_for_web.html
# by the link: https://raw.githubusercontent.com/godotengine/godot/master/platform/web/serve.py
